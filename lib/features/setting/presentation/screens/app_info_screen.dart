            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildInfoRow(Icons.book, "Tên đồ án", "Xây dựng ứng dụng quản lý chi tiêu cá nhân NoraNote", primaryColor),
                  const SizedBox(height: 16),
                  _buildInfoRow(Icons.school, "Giảng viên hướng dẫn", "TS. Lê Nguyễn Tuấn Thành", primaryColor),
                  const SizedBox(height: 16),
